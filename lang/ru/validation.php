...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Ниже приведены стандартные сообщения об ошибках, используемые классом
    | валидатора. Некоторые из правил имеют несколько вариантов, например
    | правила размера. При необходимости отредактируйте эти сообщения.
    |
    */
    ...
    'any_of' => 'Недопустимое значение поля :attribute.',
    ...
    'email' => 'Поле :attribute должно быть действительным адресом e-mail.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute обнаружено в утечках данных. Пожалуйста, выберите другой :attribute.',
    ],
    ...
    */
    ...
    | на что-то более дружелюбное, например «E-Mail адрес» вместо «email».
