...
<div class="px-inner-section-x to-top-dark">
    <div
        class="dark:bg-background-dark-add border-border relative container mx-auto mt-16 min-h-20 w-full max-w-1290 border-b bg-white bg-cover bg-top bg-no-repeat pt-px bg-blend-multiply"
