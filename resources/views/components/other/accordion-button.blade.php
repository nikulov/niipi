...
>
    <div class="flex text-left justify-start items-center gap-2">
        @if($type == 'white')
        <span class="hidden md:block text-accordion-title text-accent-add min-w-14">{{$point}}</span>
    ...
    <div class="flex justify-end items-center gap-4">
        ...
        <div class="w-8 h-4 relative
                    ...
                    before:bg-[url('/resources/images/layout/acc-arrow-white.svg')]
                    ...
                    after:bg-[url('/resources/images/layout/acc-arrow-white.svg')]
