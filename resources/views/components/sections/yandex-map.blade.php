...
<script>
    async function initMap() {
        ...
        const centerCoords = [37.632062, 55.783463];
        const targetCoords = [37.632152, 55.78491];

        const map = new YMap(document.getElementById('map'), {
            location: { center: centerCoords, zoom: 15 },
        });
        ...
        const bottomControls = new YMapControls({ position: 'bottom right' });
        bottomControls.addChild(new YMapOpenMapsButton());
