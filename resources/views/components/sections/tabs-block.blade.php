...
<section class="px-inner-section-x my-inner-section-y mx-auto w-full max-w-1242" x-data="{ active: {{ $defaultIndex ?? 0 }} }">
    <div class="px-inner-section-x translate-y-px overflow-hidden">
        @foreach ($tabs as $index => $tab)
            <button
                type="button"
                class="text-big text-text dark:text-white-dark overflow-hidden border border-b-0 px-10 py-1.5 transition-colors focus:outline-none"
