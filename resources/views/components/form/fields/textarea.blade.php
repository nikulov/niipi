...
<textarea
    ...
    rows="1"
    class="border-b-primary placeholder dark:border-b-accent-dark dark:focus:border-b-accent-add-dark focus:border-b-accent text-text dark:text-white-dark w-full resize-none overflow-hidden border-b px-3 py-2 text-sm focus:outline-none"
></textarea>
