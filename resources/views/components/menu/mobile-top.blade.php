...
>
    ...
    <div
        ...
        class="fixed inset-0 z-50 touch-pan-y overflow-hidden"
    >
        <div
            aria-hidden="true"
            class="dark:bg-background-dark bg-accent pointer-events-none absolute inset-0 bg-[url('/resources/images/layout/bg-mobile-menu.png')] bg-cover bg-center bg-blend-multiply"
        ></div>

        <div class="relative h-dvh overflow-y-auto overscroll-contain">
            ...
            <div class="flex flex-col justify-center">
                <div class="flex items-center justify-center space-x-8 bg-white/60">
                    <ul
                        class="px-inner-section-x flex w-full flex-col items-center justify-center space-x-6"
