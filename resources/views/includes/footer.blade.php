<footer
    class="to-top-white m-auto flex w-full max-w-1600 items-end justify-center bg-[#5B8EAE] bg-[url('/resources/images/layout/bg_footer.jpg')] bg-cover bg-center bg-no-repeat bg-blend-multiply lg:min-h-32 dark:bg-[#2F4A5F] dark:bg-[url('/resources/images/layout/bg_footer.jpg')]"
>
    <div class="mx-auto w-316.75 lg:px-0 lg:py-14">
