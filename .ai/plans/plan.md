...
- [Закрытые баги](archived/bugs.md) — #1, #3–#6, #15, #17–#21 с полными
...
- [bugs.md](bugs.md) — только открытое: #2 (отложен с планом), #7–#14 и
  #16 (P2/P3). Всего заведён 21 пункт — 14 из deep-review 2026-07-14,
