...
- [Закрытые баги](archived/bugs.md) — #1–#12, #15, #17–#21 с полными
...
- [bugs.md](bugs.md) — только открытое: #13, #14, #16 (P3-cleanup).
  P0/P1/P2 закрыты целиком. Всего заведён 21 пункт — 14 из deep-review 2026-07-14,
