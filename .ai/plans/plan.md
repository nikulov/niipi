...
- [bugs.md](bugs.md) — 21 баг и cleanup-задача (P0–P3, с трассами и планами
  фикса): 14 из deep-review 2026-07-14, #15–#16 из ревью published_at,
  #17–#21 из ревью 2026-08-04. Открыты #2, #4, #5, #7–#14, #16.
