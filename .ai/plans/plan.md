...
- [Закрытые баги](archived/bugs.md) — #1, #3–#7, #10, #12, #15, #17–#21 с полными
...
- [Идемпотентность писем по заявкам](form-mail-idempotency/README.md) —
  баг #2, разобран и **отложен 2026-08-04** как некритичный: код оставлен
  как есть, готовый план фикса лежит в файле.
...
- [bugs.md](bugs.md) — только открытое: #2 (отложен с планом), #8, #9,
  #11, #13, #14, #16 (P2/P3). Всего заведён 21 пункт — 14 из deep-review 2026-07-14,
  #15–#16 из ревью published_at, #17–#21 из ревью 2026-08-04; закрытые
