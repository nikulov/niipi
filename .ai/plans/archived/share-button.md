...
> **Решение «в админке ничего не настраивается» отменено 2026-08-17.** Набор
> кнопок вынесен в репитер схемы блока — см.
> [share-button-repeater/README.md](../share-button-repeater/README.md).
> Разбор ниже актуален во всём остальном (механика `share()`, MAX, `clip-path`,
> `aria-expanded`).
