        ...
        return $schema->components([
            ...
            Section::make(__('panel.general'))
                ...
                ->schema([
                    ...
                    // Until now the only way to learn why a letter never arrived
                    // was the log: the field was written but never displayed.
                    TextEntry::make('error_message')->label(__('panel.error_message'))
                        ->color('danger')
